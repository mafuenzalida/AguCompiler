...
public class TreePrinter implements TreeVisitor
{
    ...
    public void visit (TypeID node) {
        println ("TypeID <<", node.getName(), ">> [" + node.type.name + "]");
    }

    public void visit (DirectAccess node) {
        println ("Attribute <<", node.getName(), ">> [" + node.type.name + "]");
    }

    public void visit (StringExpr node) {
        println ("String <<", node.getName(), ">> [" + node.type.name + "]");
    }
    public void visit (IntExpr node) {
        println ("Int <<", node.getName(), ">> [" + node.type.name + "]");
    }
    public void visit (CharExpr node) {
        println ("Char <<", node.getName(), ">> [" + node.type.name + "]");
    }
    public void visit (BoolExpr node) {
        println ("Bool <<", node.getName(), ">> [" + node.type.name + "]");
    }
    public void visit (IdExpr node) {
        println ("Id <<", node.getName(), ">> [" + node.type.name + "]");
    }
    ...
    public void enter (TypeRA node) {
        println ("type -> type [" + node.type.name + "]");
        incrDepth ();
    }
    ...
    public void enter (AliasDecl node) {
        println("Alias <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth ();
    }
    ...
    public void enter (VarDecl node) {
        println("Var <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth ();
    }
    ...
    public void enter (ConstDecl node) {
        println("Constant <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (ClassDef node) {
        ...
        if(string.toString() != "")
            string.append(" ");
        string.append("Class <<" + node.getName() + ">> [" + node.type.name + "]");
        println(string.toString());
        incrDepth();
    }
    ...
    public void enter (FuncDef node) {
        println("Function <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (FuncArg node) {
        println("Arg <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (ObjDef node) {
        println("Object <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (FuncCall node) {
        println("FuncCall or attribute access [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (LetExpr node) {
        println("Let_Expr <<", node.getName(), ">> [" + node.type.name + "]");
        incrDepth();
    }
    ...
    public void enter (CondExpr node) {
        println("Condition [" + node.type.name + "]");
        incrDepth();
    }
