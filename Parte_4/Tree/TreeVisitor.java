...
{
    /* En los nodos que siempre son hojas, se define un solo método
     * visit, siguiendo la definición estándar del patrón. Por otra
     * parte, si el nodo tiene hijos, se crean dos métodos, uno de
     * entrada y otro de salida. Esto permite manejar la profundidad
     * dentro del árbol (aumentar al entrar y disminuir al salir), y
     * también recorrerlo de distintas formas, como preorden (usando
     * enter) o postorden (usando exit). */
